...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="At_Training",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11At_Training31AccidentScenario_ViewController")
@interface AccidentScenario_ViewController : UIViewController
- (void)viewDidLoad;
...
@interface AltitudeVC : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate>
...
SWIFT_CLASS("_TtC11At_Training11AppDelegate")
...
SWIFT_CLASS("_TtC11At_Training7MyLabel")
...
@interface ROLLVC : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, weak) IBOutlet UIPickerView * _Null_unspecified picker;
- (void)viewDidLoad;
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView * _Nonnull)pickerView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)pickerView:(UIPickerView * _Nonnull)pickerView numberOfRowsInComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC11At_Training21Random_ViewController")
@interface Random_ViewController : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface RateOfDecentVC : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, weak) IBOutlet UIPickerView * _Null_unspecified picker;
- (void)viewDidLoad;
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView * _Nonnull)pickerView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)pickerView:(UIPickerView * _Nonnull)pickerView numberOfRowsInComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC11At_Training13SceneDelegate")
...
SWIFT_CLASS("_TtC11At_Training10Use_Record")
@interface Use_Record : RealmSwiftObject
@property (nonatomic, copy) NSString * _Nonnull User_ID;
@property (nonatomic, copy) NSString * _Nonnull Aircraft_Type;
@property (nonatomic, copy) NSString * _Nonnull Tail_Number;
